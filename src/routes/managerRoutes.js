...
router.put('/issues/:id/assign', requireManagerOrAdmin(), managerController.assignIssue);
router.put('/issues/:id/priority', requireManagerOrAdmin(), managerController.updateIssuePriority);
router.put('/issues/:id/status', requireManagerOrAdmin(), managerController.updateIssueStatus);
router.put('/issues/:id/resolve', requireManagerOrAdmin(), managerController.resolveIssue);
router.put('/issues/:id/reject', requireManagerOrAdmin(), managerController.rejectIssue);
router.put('/issues/:id/rework', requireManagerOrAdmin(), managerController.requestRework);

// Worker management endpoints
router.get('/workers', requireManagerOrAdmin(), managerController.getWorkers);
router.get('/workers/:id', requireManagerOrAdmin(), managerController.getWorkerProfile);
